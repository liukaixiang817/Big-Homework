...
int main()
{
    ...
    switch(choice1)
    {
            ...
            switch(choice2)
            {
                case '1':
                    if(student_tot==-1)
                    {
                        ...
                        {
                            fscanf(fp,"%d%s%s%d%d%d%s%d",&student[i].num,student[i].passwd,student[i].name,&student[i].cou1,&student[i].cou2,&student[i].cou3,student[i].major,&student[i].status);
                        }
                        fclose(fp);
                    }
                    StudentMenu:
                    ...
                    printf("6.Reset Students' Informations\n");
                    printf("7.Show The Recycle Bin\n");
                    ...
                    switch(choice3)
                    {
                        ...
                        case '2':
                            ...
                            student[student_tot].passwd[0]='$';
                            student[student_tot].cou1=-1;
                            student[student_tot].cou2=-1;
                            student[student_tot].cou3=-1;
                            student_tot++;
                        ...
                        case '6':
                            printf("Please input the student's number who you are going to reset the password:");
                            int student_temp10;
                            fflush(stdin);
                            scanf("%d",&student_temp10);
                            for(int i=0;i<student_tot;i++)
                            {
                                if(student[i].num==student_temp10&&(student[i].status))
                                {
                                    student[i].passwd[0]='$';
                                    printf("The password has been successfully reset...\n");
                                    sleep(1);
                                    break;
                                }
                                if(i==student_tot-1)
                        ...
                        default:
                            ...
                            for(int i=0;i<student_tot;i++)
                            {
                                fprintf(fp,"%d %s %s %d %d %d %s %d\n",student[i].num,student[i].passwd,student[i].name,student[i].cou1,student[i].cou2,student[i].cou3,student[i].major,student[i].status);
                            }
                            student_tot=-1;
                            fclose(fp);
                            goto AdminMenu;
                ...
                case '3':
                    ...
                    switch(choice9)
                    {
                        case '1':
                            ...
                            {
                                int j=0;
                                while(cnt[course[i].cap-course[i].source][j]!=-1)
                                {
                                    j++;
                                }
                                cnt[course[i].cap-course[i].source][j]=i;
                            }
                            printf("The result is:\n");
                            printf("Name\t\t\t\tPopulation\n");
                            for(int i=1000;i>=0;i--)
                            {
                                int j=0;
                                while(cnt[i][j]!=-1)
                                {
                                    printf("%s\t\t\t\t%d\n",course[cnt[i][j]].name,course[cnt[i][j]].cap-course[cnt[i][j]].source);
                                    j++;
                                }
                            }
                            printf("Finished...\n");
                        ...
                        case '2':
                        {
                            ...
                            for(int i=0;i<course_tot;i++)
                            {
                                if(!strcmp(majorn,course[i].major))
                                {
                                    flg=1;
                                    int j=0;
                                    while(cnt1[course[i].cap-course[i].source][j]!=-1)
                                    {
                                        j++;
                                    }
                                    cnt1[course[i].cap-course[i].source][j]=i;
                                }
                            }
                            if(!flg)
                            {
                            ...
                            for(int i=1000;i>=0;i--)
                            {
                                ...
                                while(cnt1[i][j]!=-1)
                                {
                                    printf("%s\t\t\t\t%d\n",course[cnt1[i][j]].name,course[cnt1[i][j]].cap-course[cnt1[i][j]].source);
                                    j++;
                                }
                            }
                            printf("Finished...\n");
        ...
        case '2':
            ...
            switch(choice5)
            {
                case '1':
                {
                    ...
                    for(int i=0;i<student_tot;i++)
                    {
                        if(acc==student[i].num)
                        {
                            char pwd[109];
                            if(student[i].passwd[0]=='$')
                            {
                                printf("Please enter your new password:");
                                fflush(stdin);
                                scanf("%s",student[i].passwd);
                                goto StuMenu;
                            }
                            printf("Please enter your password:");
                            fflush(stdin);
                            scanf("%s",pwd);
                            if(!strcmp(pwd,student[i].passwd))
                            {
                                StuMenu:
                                printf("Login successfully...\n");
                                ...
                                switch(choice6)
                                {
                                    case '1':
                                        ...
                                        if(student[i].cou1!=-1)
                                        {
                                            printf("%s\t\t",course[student[i].cou1].name);
                                        }
                                        else
                                        {
                                            printf("NONE\t\t");
                                        ...
                                        if(student[i].cou2!=-1)
                                        {
                                            printf("%s\t\t",course[student[i].cou2].name);
                                        }
                                        else
                                        {
                                            printf("NONE\t\t");
                                    ...
                                    case '2':
                                        ...
                                        switch(choice7)
                                        {
                                            case '1':
                                            {
                                                ...
                                                if(student[i].cou1!=-1)
                                                {
                                                    course[student[i].cou1].source++;
                                                }
                                                int flg=0;
                                                for(int j=0;j<course_tot;j++)
                                                {
                                                    if(course[j].status&&(!strcmp(course[j].major,student[i].major))&&(j!=student[i].cou1)&&(j!=student[i].cou2)&&(j!=student[i].cou3))
                                                    {
                                                        flg=1;
                                                        printf("  %d\t\t\t%s\n",j,course[j].name);
                                                    }
                                                ...
                                                if(!flg)
                                                {
                                                    printf("No course is right for you...\n");
                                                    sleep(1);
                                                    goto StuMenu2;
                                                }
                                                printf("Please input the course's number which you would like to choose:");
                                                fflush(stdin);
                                                scanf("%d",&student[i].cou1);
                                                if(course[student[i].cou1].source>0)
                                                {
                                            ...
                                            case '2':
                                            {
                                                ...
                                                printf("Please input the course's number which you would like to choose:");
                                                fflush(stdin);
                                                scanf("%d",&student[i].cou2);
                                                if(course[student[i].cou2].source>0)
                                                {
                                                    printf("The course has been chosen successfully...\n");
                                                    course[student[i].cou2].source--;
                                                }
                                            ...
                                            case '3':
                                            {
                                                ...
                                                printf("Please input the course's number which you would like to choose:");
                                                fflush(stdin);
                                                scanf("%d",&student[i].cou3);
                                                if(course[student[i].cou3].source>0)
                                                {
                                                    printf("The course has been chosen successfully...\n");
                                                    course[student[i].cou3].source--;
                                                }
                                    ...
                                    default:
                                        ...
                                        for(int j=0;j<course_tot;j++)
                                        {
                                            fprintf(fp,"%s %d %s %d %d\n",course[j].name,course[j].cap,course[j].major,course[j].status,course[j].source);
                                        }
                                        course_tot=-1;
                                        fclose(fp);
                                        FILE *fp1=fopen(buffer3,"w");
                                        fprintf(fp1,"%d\n",student_tot);
                                        for(int j=0;j<student_tot;j++)
                                        {
                                            fprintf(fp1,"%d %s %s %d %d %d %s %d\n",student[j].num,student[j].passwd,student[j].name,student[j].cou1,student[j].cou2,student[j].cou3,student[j].major,student[j].status);
                                        }
                                        student_tot=-1;
                                        fclose(fp1);
                                        sleep(1);
                            ...
                            else
                            {
                                    ...
                                    fflush(stdin);
                                    scanf("%s",pwd2);
                                    if(strcmp(pwd2,student[i].passwd)!=0)
                                    {
                                        printf("You may have 1 more chance to enter the correct password.\n");
                                        printf("Please input the password:");
                                        ...
                                        fflush(stdin);
                                        scanf("%s",pwd3);
                                        if(strcmp(pwd3,student[i].passwd)!=0)
                                        {
                                            printf("Sorry, the program will exit...\n");
                                            return 0;
                                        }
                ...
                case '2':
                {
                    printf("Please input your student number:");
                    fflush(stdin);
                    scanf("%d",&student[student_tot].num);
                    printf("Please input your password:");
                    fflush(stdin);
                    scanf("%s",student[student_tot].passwd);
                    printf("Please input your name:");
                    fflush(stdin);
                    scanf("%s",student[student_tot].name);
                    printf("Please input your major:");
                    fflush(stdin);
                    scanf("%s",student[student_tot].major);
                    student[student_tot].cou1=-1;
                    student[student_tot].cou2=-1;
                    student[student_tot].cou3=-1;
                    student[student_tot].status=1;
        ...
        case '3':
            ...
            CreateProcess(buffer5, NULL, NULL, NULL, FALSE, CREATE_NEW_CONSOLE, NULL, NULL, &si, &pi);
            return 0;
        default:
