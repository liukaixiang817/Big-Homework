...
int main()
{
    ...
    printf("***********************LOGIN************************\n");
    int login_temp;
    FILE *fp=fopen(buffer1,"r");//*相对路径异常*，暂时引用为绝对路径
    ...
    fclose(fp);
    FILE *fp2=fopen(buffer1,"w");//*相对路径异常*，暂时引用为绝对路径
    fprintf(fp2,"1\n");
    ...
    switch(choice1)
    {
        case '1':
            ...
            switch(choice2)
            {
                case '1':
                    if(student_tot==-1)
                    {
                        FILE *fp=fopen(buffer3,"r");//*相对路径异常*，暂时引用为绝对路径
                    ...
                    switch(choice3)
                    {
                        ...
                        default:
                            FILE *fp=fopen(buffer3,"w");//*相对路径异常*，暂时引用为绝对路径
                            fprintf(fp,"%d\n",student_tot);
                            for(int i=0;i<student_tot;i++)
                            {
                ...
                case '2':
                    if(course_tot==-1)
                    {
                        FILE *fp=fopen(buffer2,"r");//*相对路径异常*，暂时引用为绝对路径
                    ...
                    switch(choice4)
                    {
                        ...
                        case '5':
                            ...
                            break;
                        default:
                            FILE *fp=fopen(buffer2,"w");//*相对路径异常*，暂时引用为绝对路径
                            fprintf(fp,"%d\n",course_tot);
                            for(int i=0;i<course_tot;i++)
                            {
        ...
        case '2':
            ...
            FILE *fp=fopen(buffer4,"r");//*相对路径异常*，暂时引用为绝对路径
            ...
            switch(choice5)
            {
                            ...
                            if(!strcmp(pwd,stulog[i].passwd))
                            {
                                ...
                                switch(choice6)
                                {
                                    ...
                                    default:
                                        ...
                                        course_tot=-1;
                                        fclose(fp);
                                        FILE *fp1=fopen(buffer4,"w");//*相对路径异常*，暂时引用为绝对路径
                                        fprintf(fp1,"%d\n",login_stu);
                                        for(int i=0;i<login_stu;i++)
                                        {
                ...
                case '2':
                {
                    ...
                    login_stu++;
                    FILE *fp=fopen(buffer4,"w");//*相对路径异常*，暂时引用为绝对路径
                    fprintf(fp,"%d\n",login_stu);
                    for(int i=0;i<login_stu;i++)
                    {
